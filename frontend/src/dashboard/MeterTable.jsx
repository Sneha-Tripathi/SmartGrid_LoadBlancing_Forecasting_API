...
const dummyMeters = [
  ...
  { id: "MTR-1004", zone: "West", load: "275 kW", voltage: "229 V", status: "Active" },
  { id: "MTR-1005", zone: "Central", load: "342 kW", voltage: "231 V", status: "Critical" },
];
...
const MeterTable = memo(function MeterTable() {
  ...
  if (!meters || meters.length === 0) {
    return <EmptyState title="No Meter Data" message="No smart meter records found." />;
  }
  if (error) console.warn("Meter API unavailable. Showing dummy data.");

  return (
    <div className="bg-[#101827] border border-slate-800 rounded-2xl p-6">
      <h2 className="text-xl font-semibold text-white mb-5">Smart Meter Monitoring</h2>
