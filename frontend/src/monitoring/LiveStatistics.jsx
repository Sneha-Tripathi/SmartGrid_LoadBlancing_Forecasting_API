  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="bg-[#101827] border border-slate-800 rounded-2xl p-6">
        ...
        <h2 className="text-2xl font-bold text-white mt-4">{liveData?.status ?? "--"}</h2>
      </div>
      <div className="bg-[#101827] border border-slate-800 rounded-2xl p-6">
        <div className="flex justify-between items-center">
        ...
        <h2 className="text-2xl font-bold text-white mt-4">{liveData?.timestamp ?? "--"}</h2>
      </div>
      <div className="bg-[#101827] border border-slate-800 rounded-2xl p-6">
        <div className="flex justify-between items-center">
        ...
        <p className="text-white mt-4 font-semibold">{liveData?.alert ?? "No Alerts"}</p>
      </div>
      <div className="bg-[#101827] border border-slate-800 rounded-2xl p-6">
        <div className="flex justify-between items-center">
          <h3 className="text-slate-400">Connection</h3>
          <FaWifi className={connected ? "text-green-400" : "text-red-400"} />
        </div>
        <h2 className={connected ? "text-green-400 text-2xl font-bold mt-4" : "text-red-400 text-2xl font-bold mt-4"}>{connected ? "Online" : "Offline"}</h2>
      </div>
    </div>
  );
});
