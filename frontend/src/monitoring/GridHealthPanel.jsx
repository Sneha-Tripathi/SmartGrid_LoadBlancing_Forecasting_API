import { FaCheckCircle, FaExclamationTriangle, FaBolt, FaBroadcastTower } from "react-icons/fa";
  ...
  return (
    <div className="bg-[#101827] border border-slate-800 rounded-2xl p-6">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold text-white">Smart Grid Health</h2>
        {icon}
      </div>
      <div className="mt-6 space-y-4">
        <div>
          <p className="text-slate-400 text-sm">Grid Status</p>
          <h3 className={"text-2xl font-bold mt-1 " + statusColor}>{status}</h3>
        </div>
        <div>
        ...
        <div>
          <p className="text-slate-400 text-sm">Current Alert</p>
          <div className="flex items-center gap-2 mt-1">
